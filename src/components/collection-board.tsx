      ...
      >
        ...
        >
          ...
          {editingItem === item.id ? <div className="inline-item-editor">
            ...
            <a className="collection-card-link" href={item.href} target="_blank" rel="noreferrer" title={item.note || item.description || item.title} onClick={(event) => { if (managing && kind === "bookmark") { event.preventDefault(); beginItemEdit(item); } }}>
